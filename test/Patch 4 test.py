...
splash = SplashScreen(root, gif_path="pics/IntroGIF.gif", delay=3500)
# once splash is destroyed, de‐hide and start main app
def on_splash_close():
    root.deiconify()
    app = ExpirationApp(root)
splash.bind("<Destroy>", lambda e: on_splash_close())
root.mainloop()
'''
if __name__ == "__main__":
#  root = tk.Tk()
